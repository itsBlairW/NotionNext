...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 
    `🇨🇳 ➡️ 🇨🇦 /n
    🎓 Bsc | Kingston | QU | 23' /n
    🎓 MEng | London | UWO | 24' /n
    🔧 Software engineer | Machine Learning Engineer | Data Engineer`, // 作者简介
  ...
  CONTACT_FACEBOOK: process.env.NEXT_PUBLIC_CONTACT_FACEBOOK || 'https://www.facebook.com/profile.php?id=100087989295204&mibextid=LQQJ4d', // 你的telegram 地址 例如 https://t.me/tangly_1024
