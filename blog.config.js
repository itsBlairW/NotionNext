...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || "🇨🇳 ➡️ 🇨🇦" 
  BIO: process.env.NEXT_PUBLIC_BIO || "🎓 Bsc | Kingston | QU | 23' "
  BIO: process.env.NEXT_PUBLIC_BIO || "🎓 MEng | London | UWO | 24' "
  BIO: process.env.NEXT_PUBLIC_BIO || "🔧 Software engineer | Machine Learning Engineer | Data Engineer`, // 作者简介
