...
const BLOG = {
  ...
  "Hi It's Blair, Welcome to my Blog🥰",


  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Blair Wang', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || "🇨🇳 ➡️ 🇨🇦 🎓 Bsc | Kingston | QU | 23' 🎓 MEng | London | UWO | 24' 🔧 Software engineer | Machine Learning Engineer | Data Engineer", // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://itsblair.vercel.app/en', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Blair, Blog', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '18jw111@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://x.com/whitenox0917', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/itsBlairW', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      name: '假装快乐',
      artist: '胡66',
      url: 'https://music.163.com/outchain/player?type=2&id=2014019634&auto=1&height=66',
      cover:
  ...
  COMMENT_VALINE_PLACEHOLDER:
    process.env.NEXT_PUBLIC_VALINE_PLACEHOLDER || 'Leave your opinion🎀', // 可以搭配后台管理评论 https://github.com/DesertsP/Valine-Admin  便于查看评论，以及邮件通知，垃圾评论过滤等功能
